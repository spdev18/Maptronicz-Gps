...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    maptroniczGPSAuthUserSubject.add(
      MaptroniczGPSAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<MaptroniczGPSAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  MaptroniczGPSAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = MaptroniczGPSAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    maptroniczGPSAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
MaptroniczGPSAuthUser? currentUser;
