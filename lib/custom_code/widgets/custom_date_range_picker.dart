...
class _CustomDateRangePickerState extends State<CustomDateRangePicker> {
  ...
  String _getValueText(
    ...
    var valueText = (values.isNotEmpty ? values[0] : null)
        .toString()
        .replaceAll('00:00:00', '00:00:00');

    if (datePickerType == CalendarDatePicker2Type.multi) {
      valueText = values.isNotEmpty
          ? values
              .map((v) => v.toString().replaceAll('00:00:00', '00:00:00'))
              .join(', ')
          : 'null';
    } else if (datePickerType == CalendarDatePicker2Type.range) {
      if (values.isNotEmpty) {
        final startDate =
            values[0].toString().replaceAll('00:00:00', '00:00:00');
        final endDate = values.length > 1
            ? values[1].toString().replaceAll('00:00:00', '00:00:00')
            : 'null';
  ...
  _buildCalendarDialogButton() {
    ...
    final config = CalendarDatePicker2WithActionButtonsConfig(
      ...
      selectedDayHighlightColor: widget.iconColor,
