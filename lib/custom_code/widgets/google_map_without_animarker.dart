...
class GoogleMapWithoutAnimarker extends StatefulWidget {
  const GoogleMapWithoutAnimarker({
    super.key,
    this.width,
    this.height,
  ...
  @override
  State<GoogleMapWithoutAnimarker> createState() =>
      _GoogleMapWithoutAnimarkerState();
}

class _GoogleMapWithoutAnimarkerState extends State<GoogleMapWithoutAnimarker> {
  Timer? _timer;
  ...
  void initState() {
    ...
    _timer = Timer.periodic(const Duration(seconds: 5), (Timer t) => makeApiCall());
  }
    ...
    return Container(
      ...
      children: [
        gm.GoogleMap(
          ...
          markers: Set<gm.Marker>.of(_markers), // Manually update markers
          polylines: {
            gm.Polyline(
