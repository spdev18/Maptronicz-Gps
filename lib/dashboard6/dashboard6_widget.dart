                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'zn1pn6wr' /* Your recent activity is below. */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'uamu7iwu' /* A summary of outstanding tasks... */,
                            ),
                            style:
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'zxyryo3k' /* Task Description here this one... */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'pb5l0p5j' /* Task Description here this one... */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
